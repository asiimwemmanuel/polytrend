...
from PySide6.QtWidgets import QCheckBox, QGridLayout, QLabel, QPlainTextEdit, QPushButton, QStatusBar, QTextEdit, QVBoxLayout, QWidget

class PolyTrendUi(object):
	def setupUi(self, PolyTrend):
		if not PolyTrend.objectName():
			PolyTrend.setObjectName(u"PolyTrend")
		PolyTrend.resize(398, 398)
	...
	def retranslateUi(self, PolyTrend):
		PolyTrend.setWindowTitle(QCoreApplication.translate("PolyTrend", u"MainWindow", None))
...
"It is assumed that values on the same row\n"
"correspond to the same point.", None))
...
"(optional)", None))
		...
		self.plot.setText(QCoreApplication.translate("PolyTrend", u"Find", None))
