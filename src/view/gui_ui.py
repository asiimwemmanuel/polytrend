...
class Ui_PolyTrend(object):
    ...
    def retranslateUi(self, PolyTrend):
        PolyTrend.setWindowTitle(
            QCoreApplication.translate("PolyTrend", "PolyTrend", None)
        )
        ...
        self.intro.setText(
            QCoreApplication.translate(
                ...
                "Saved PNGs will be in the 'images' folder of the application directory\n"
                "For the algebraic expressions of the models, check console output",
                None,
            )
        )
        ...
        self.label_3.setText(
            QCoreApplication.translate("PolyTrend", "x\n" "values", None)
        )
        self.label_4.setText(
            QCoreApplication.translate("PolyTrend", "f(x)\n" "values", None)
        )
        ...
        self.plot.setText(
            QCoreApplication.translate("PolyTrend", "Fit polynomial", None)
        )
